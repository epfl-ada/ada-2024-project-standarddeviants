...
def sort_diseases(disease_name: str) -> str:
    ...
    in_mapping = {
        ...
        "Cancer": ["leukemia", "oncogene", "hemangioma", "glioma", "tumor", "melanoma"],
        "Obesity": [],
        "Neoplasia": [],
        ...
        "Lipodystrophy": [],
        "Schizophrenia": [],
        "Deafness": ["deafness", "hearing loss syndrom"],
        "Blindness": ['blindness', 'corneal dystrophy'],
        "Crouzon syndrome": ["Crouzon syndrome"],
        "Ataxia": ["ataxia"],
        'Hypothyroidism': ['hypothyroidism'],
        'Hyperparathyroidism': ['hyperparathyroidism'],
        "Thyroid hormone resistance": ['thyroid hormone resistance'],
        ...
        'Atrial standstill': ['atrial standstill'],
        'Osteonecrosis': ['osteonecrosis', 'avascular necrosis of the femoral head'],
